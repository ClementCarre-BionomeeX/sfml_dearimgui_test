...
CXXFLAGS = -I/usr/include/SDL2 -Werror -Wpedantic -Wconversion -Wsign-conversion -Woverloaded-virtual -Wshadow -Wnon-virtual-dtor -Wcast-align -Wall -Wextra -std=c++17 -O3  $(shell pkg-config --cflags gtk+-3.0)
